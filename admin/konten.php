  ...
  <div class="flex min-h-screen">
    <aside class="w-64 bg-transparent shadow-lg p-4">
      ...
      <nav class="space-y-4 mt-4">
        ...
        <button type="button" onclick="window.location.href='faq.php' "class="block w-full text-left font-semibold text-[#284B63] px-4 py-2 hover:bg-[#9BD8DB] rounded">FAQ</button>
        <button type="button" onclick="window.location.href='konten.php' "class="block w-full text-left font-semibold text-white bg-[#3C949E] rounded px-4 py-2">Content</button>
    ...
    <div class="flex-1 flex flex-col">
      <header class="w-322 h-15 bg-[#9BD8DB] shadow-lg flex items-center gap-4 px-4 py-2">
        ...
        <input placeholder="search..." class="w-200 h-8 px-2 bg-white rounded-md shadow-lg">
        <div class="flex items-center gap-2">
          <div class="w-10 h-10">
            <img src="./image/image 20.png" alt="logo" class="w-full h-full rounded-full object-cover">
          </div>
          <h1 class="text-[21px] font-semibold text-[#000000]">Mediora</h1>
        </div>
      </header>
  ...
  <div id="tambahKonten" class="konten">
    <div class="konten-content">
      ...
      <form>
        ...
        <button type="button" onclick="closeKonten()" class="bg-[#024F55] text-white text-[12px] px-4 py-2 w-full h-10 rounded-lg font-medium hover:bg-[#337c84] transition duration-200">
          TAMBAHKAN KONTEN
        </button>
      </form>
    </div>
