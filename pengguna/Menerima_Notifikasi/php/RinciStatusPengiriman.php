...
<head>
  ...
  <style>
    ...
    .timeline-track .line {
        position: absolute;
        top: 12px;
        height: 40px; /* Sesuaikan panjang garis */
        width: 2px;
        background-color: #ccc;
        z-index: 0;
    }
...
<body>
  <div class="bg">
    <div class="popup">
      ...
      <div class="content">
        <h2 class="status-title">Status Pengiriman</h2>
        ...
        <a href="StatusPengiriman.php" class="close-btn" style="display: block; text-align: center; text-decoration: none;">TUTUP</a>
        </div>
      </div>
